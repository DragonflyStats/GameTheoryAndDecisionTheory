...
The Bishop–Cannings theorem is a theorem in evolutionary game theory. It states that 
\begin{enumerate}[(i)]
\item  all members of a mixed evolutionarily stable strategy (ESS) have the same payoff (Theorem 2), and
\item that none of these can also be a pure ESS[1] (from their Theorem 3). 
\end{itemize}
The usefulness of the results comes from the fact that they can be used to directly find ESSes algebraically, rather than simulating the game and solving it by iteration.
